...
| 0002 | [Public repository and public image; nothing secret](0002-public-and-secret-free.md) | Accepted |
...
| 0005 | [Accounts: root locked, localadmin local-only, no password in the image](0005-accounts-and-access.md) | Accepted |
...
| 0008 | [Daily users are systemd-homed LUKS homes on a separate partition](0008-homed-users-on-a-separate-partition.md) | Accepted |
...
| 0011 | [Keep Homebrew, owned by one user](0011-homebrew-single-owner.md) | Accepted |
