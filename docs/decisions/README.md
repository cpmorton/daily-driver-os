...
| 0002 | [Public repository and public image; nothing secret](0002-public-and-secret-free.md) | Accepted, amended by 0018, 0019, 0020 |
...
| 0005 | [Accounts: root locked, localadmin local-only, no password in the image](0005-accounts-and-access.md) | Accepted, amended by 0018, 0019, 0020 |
...
| 0010 | [Persistent `/var`, volatile journal, tmpfs `/tmp`](0010-var-journal-tmp.md) | Accepted, amended by 0021 |
...
| 0017 | [Dual boot on the internal disk, beside Windows](0017-dual-boot-internal-disk.md) | Accepted, amended by 0021 |
| 0018 | [Provisioning: a generic installer plus a per-machine seed stick](0018-provisioning-seed-stick.md) | Superseded by 0020 |
| 0019 | [Passwords are typed at first boot, never seeded](0019-no-seeded-passwords.md) | Accepted, amended by 0020 |
